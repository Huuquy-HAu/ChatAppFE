...
let data = {
  userName : 'thocon1209',
  gmail : 'truongtho12092000@gmail.com',
  avatar :  "https://class.nodemy.vn/api/public/images/logo.png?1675910771501",
  password : "$2a$10$iLWD4mftXc85zFyEXfQDtuVy69adIdTmbF5V4YHjzEuQ.blvOoJbK",
  role : 2,
  listFriend : []
}
      ...
      <div className="wrapper">
        ...
        <div className="profile-card js-profile-card">
          <div className="profile-card__img">
              <img src={data.avatar} alt="profile card" />
          </div>

          <div className="profile-card__cnt js-profile-cnt">
            <div className="profile-card__name">{data.userName}</div>
            <div className="profile-card__txt"> {data.gmail} </div>
            ...
            <div className="profile-card-inf">
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">{countFriend(data)}</div>
                <div className="profile-card-inf__txt">Bạn Bè</div>
              </div>
            ...
            <div className="profile-card-ctr">
              <Button className="profile-card__button button--blue js-message-btn" type="primary" onClick={showModal}>
                Chỉnh sửa thông tin tài khoản
              </Button>
              <Modal title="Chỉnh sửa thông tin tài khoản" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
                ...
                <div>
                  ...
                  <Form.Item wrapperCol={{offset: 8,span: 16,}}>
                    <Button className='updateBtn' type="primary" htmlType="submit">
                      Update
                    </Button>
                  </Form.Item>
                </Form>
